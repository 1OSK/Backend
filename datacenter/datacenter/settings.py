...
AUTH_USER_MODEL = 'datacenter_app.CustomUser'  # Укажите имя вашего приложения и модели
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Добавляем глобальную папку templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
